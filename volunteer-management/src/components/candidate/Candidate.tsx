        ...
        <li key={key} className="collapse bg-zinc-200">
            ...
            <div className="collapse-content grid grid-cols-2">
                ...
                <div className="col-span-2 flex justify-center">
                    <select className={`select self-center font-bold text-black ${candidateData.recruitment_status === 'Accepted' ? "bg-green-600" : candidateData.recruitment_status === 'Pending' ? "bg-amber-600" : "bg-red-600"}`} name="recruitment_status" value={candidateData.recruitment_status} onChange={handleInputChange}>
